            ...
            <header className=' flex justify-between items-center px-3 md:max-w-6xl md:mx-auto'>
                ...
                <div>
                    ...
                    <ul className='flex space-x-10'>
                        ...
                        <li className={`cursor-pointer py-3 font-semibold text-gray-500 border-b-[3px] border-b-transparent ${(pathMatchRoute("/sign-in") || pathMatchRoute("Profile")) && "text-black border-b-red-500"}`} onClick={() => navigate('/profile')}>  {pagestate}</li>
                    </ul>
                </div>
            </header >
        </div >
