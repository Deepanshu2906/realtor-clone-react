...
const SignUp = () => {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // deleting the password before storing into db
      ...
      <div className="flex justify-center flex-wrap items-center py-12 px-6 lg:max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-12">
          <form onSubmit={handleSubmit}>
            <input
              className="w-full py-2 px-4 text-gray-700 bg-white text-xl rounded border-gray-300 transition ease-in-out mb-6"
              type="text"
              name=""
              id="name"
            ...
            <div className="relative mb-6">
              <input
                className="w-full py-2 px-4 text-gray-700 bg-white text-xl rounded border-gray-300 transition ease-in-out"
            ...
            <button
              className="w-full bg-blue-600 text-white py-3 px-7 font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-xl active:bg-blue-800"
              type="submit"
            >
              Sign up
            </button>
