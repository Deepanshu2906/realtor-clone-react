            ...
            <section className='max-w-6xl mx-auto'>
                ...
                <div className='w-full md:w-[50%] mt-6 px-3 mx-auto'>
                    <form action="">
                        {/*Name input */}
                        <input
                            className={`mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out ${changeDetail && "bg-red-200 focus:bg-red-250"}`} type="text" id="name" value={name} disabled={!changeDetail}
                        ...
                        <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
                            <p>Do you want to change your name?
                                <span
                                    ...
                                    className='ml-1 text-red-600 hover:text-red-700 transition ease-ini-out duration-200 cursor-pointer'>{changeDetail ? "Apply changes" : "Edit"}</span>
                            </p>
